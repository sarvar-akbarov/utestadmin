...
$this->title = Yii::t('app',Yii::t('app', 'Tests'));
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['data-pjax' => 0,'title'=> 'Create new '.Yii::t('app','Tests'),'class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
            ...
            'panel' => [
                'type' => 'success', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> ' . Yii::t('app', 'Tests'),
